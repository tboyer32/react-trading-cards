...
ReactDOM.render(
  ...
  document.querySelector('#trading-container')
);
...
// ReactDOM.render(
//   <TradingCard name="off-by-one" skill="playing video game" imgUrl="/static/img/off-by-one.jpeg"/>,
//   document.querySelector('#off-by-one')
// );

// ReactDOM.render(
//   <TradingCard name="Shortstack Overflow" skill="competitive eating" imgUrl = "/static/img/shortstack-overflow.jpeg" />,
